...
export class UserDetailsService {
  ...
  addUser(userData: UserDetails) {
    this.http.post(`${this.baseUrl}`, userData).subscribe((res) => {
  ...
  updateUser(userData: UserDetails, id: number) {
    this.http.put(`${this.baseUrl}/${id}`, userData).subscribe((res) => {
  ...
  updateOwnDetails(userData: UserDetails) {
    this.http.put(`${this.baseUrl}`, userData).subscribe((res) => {
      console.log('Details updated!');
      this.reloadComponent.next(true);
    });
  }
